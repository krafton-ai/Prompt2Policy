...
<p align="center">
  <a href="https://www.krafton.ai/blog/posts/prompt-to-policy-en.html"><img src="https://img.shields.io/badge/%F0%9F%8C%90%20Project-Page-4285F4?style=for-the-badge" alt="Project Page"/></a>
</p>
...
Open **http://localhost:3000**, enter an intent like *"do a backflip"*, and hit run. See the [dashboard tutorial](https://www.krafton.ai/blog/posts/prompt-to-policy-en.html/) for a video walkthrough. For CLI usage, see [CLI Reference](#cli-reference).
